...
#### Pike
- CI workflow: `pike -M src -e 'import Introspect;' && sh tests/pike_tests.sh`
- .gitignore: `*.o`, `*.pmod~`, `modules/`, `.pmp/`
...
2. Provide options: JavaScript/TypeScript, Rust, Go, Python, Pike, Other
