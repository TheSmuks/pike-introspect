...
**What it is:** Convention enforcement via two mechanisms: **TTSR** (stream-triggered, zero-cost) and **scope-based** (activated by file/tool patterns, always in context when relevant).
...
- [agents.md](./docs/agent-files-guide.md#b-agentsmd) — AGENTS.md guide
- [SKILL.md](./docs/agent-files-guide.md#d-skillmd) — SKILL.md guide
